...
class ChangeDiscordAccountCog(commands.Cog):
    ...
    async def zchange_discord_account(
        ...
        if bad:
            await send_to_danger_debug_channel(self.client, ctx, old_discord_id, discord.Color.red(), vlog_msg.error1)
        ...
        try:
            ...
            await send_raw_to_debug_channel(self.client, 'change discord account error', e)
            return
