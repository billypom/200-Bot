...
class WarnCog(commands.Cog):
    ...
    async def zwarn(self, ctx, 
        ...
        try:
            ...
            await send_raw_to_debug_channel(self.client, '/zwarn error - Failed to insert punishment record', e)
        ...
        try:
            ...
            await send_raw_to_debug_channel(self.client, f'/zwarn error - member [{player}] not found', e)
