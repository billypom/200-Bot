...
async def table(
    ...
    if table_view.value is None:
        ...
        correct = subprocess.run(['convert', '-background', 'None', '-fill', '#00000010', '-draw', 'rectangle 0,0 570,368', '-fill', 'white', pango_string, 'mkbg.png', '+swap', '-compose', 'Over', '-composite', '-quality', '100', mmr_filename], check=True, text=True)
