...
async def create_lorenzi_query(
    ...
    """Given a sorted list of Teams[Player, score]s, the original format for the scores, and the mogi format
    This function returns a string to be passed to gb.hlorenzi table maker"""
    if mogi_format == 1:
        lorenzi_query = "-\n"
    else:
        lorenzi_query = ""
